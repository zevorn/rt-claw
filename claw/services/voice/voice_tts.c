                                          ...
                                          size_t *out_len)
{
    ...
    for (i = 0; i < input_len; i += 4) {
        int a = voice_tts_b64_value((char)src[i + 0]);
        int b = voice_tts_b64_value((char)src[i + 1]);
        int c = src[i + 2] == '=' ? 0 : voice_tts_b64_value((char)src[i + 2]);
        int d = src[i + 3] == '=' ? 0 : voice_tts_b64_value((char)src[i + 3]);
        uint32_t chunk;
