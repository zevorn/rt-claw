...
/* ---- Voice ---- */
#ifndef CONFIG_RTCLAW_VOICE_MAX_TURN_BYTES
#ifdef CLAW_PLATFORM_LINUX
#define CONFIG_RTCLAW_VOICE_MAX_TURN_BYTES   262144
#else
#define CONFIG_RTCLAW_VOICE_MAX_TURN_BYTES   65536
#endif
#endif
#ifndef CONFIG_RTCLAW_VOICE_TEXT_BUF_SIZE
#define CONFIG_RTCLAW_VOICE_TEXT_BUF_SIZE    2048
#endif
#ifndef CONFIG_RTCLAW_VOICE_STT_RESP_SIZE
#ifdef CLAW_PLATFORM_LINUX
#define CONFIG_RTCLAW_VOICE_STT_RESP_SIZE    8192
#else
#define CONFIG_RTCLAW_VOICE_STT_RESP_SIZE    4096
#endif
#endif
#ifndef CONFIG_RTCLAW_VOICE_STT_TIMEOUT_MS
#define CONFIG_RTCLAW_VOICE_STT_TIMEOUT_MS   8000
#endif
#ifndef CONFIG_RTCLAW_VOICE_TTS_RESP_SIZE
#ifdef CLAW_PLATFORM_LINUX
#define CONFIG_RTCLAW_VOICE_TTS_RESP_SIZE    2097152
#else
#define CONFIG_RTCLAW_VOICE_TTS_RESP_SIZE    40960
#endif
#endif
#ifndef CONFIG_RTCLAW_VOICE_TTS_AUDIO_BUF_SIZE
#ifdef CLAW_PLATFORM_LINUX
#define CONFIG_RTCLAW_VOICE_TTS_AUDIO_BUF_SIZE 1048576
#else
#define CONFIG_RTCLAW_VOICE_TTS_AUDIO_BUF_SIZE 24576
#endif
#endif
