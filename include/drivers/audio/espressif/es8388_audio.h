 ...
 *
 * es8388 audio codec driver — I2C control + I2S audio data.
 * Supports playback (speaker) and capture (microphone).
 */

#ifndef CLAW_DRIVERS_AUDIO_ESPRESSIF_ES8388_AUDIO_H
#define CLAW_DRIVERS_AUDIO_ESPRESSIF_ES8388_AUDIO_H

#include <stdint.h>
#include <stddef.h>

/**
 * Initialize es8388 codec + I2S + PA on an existing I2C bus.
 *
...
#endif /* CLAW_DRIVERS_AUDIO_ESPRESSIF_es8388_AUDIO_H */
